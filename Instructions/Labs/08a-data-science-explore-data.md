...
Vamos a comprobar la característica `BMI` y trazar su distribución para comprender mejor sus características.
...
1. Agregue otra celda de código al cuaderno. A continuación, escriba el código siguiente en esta celda y ejecútelo.
    ...
    A partir de este gráfico, puede observar el intervalo y la distribución de `BMI` en el conjunto de datos. Por ejemplo, la mayor parte de `BMI` está entre 23.2 y 29.2, y los datos están sesgados a la derecha.
...
1. Use el icono **+Código** situado debajo de la salida de la celda para agregar una nueva celda de código al cuaderno y escriba el código siguiente:
    ...
    Podemos ver que a medida que `BMI` aumenta, la variable de destino también aumenta, lo que indica una relación lineal positiva entre estas dos variables.
