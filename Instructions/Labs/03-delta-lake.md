...
3. La ruta de acceso completa debe ser similar a la siguiente:
...
3. Cuando se devuelvan los datos, selecciona la vista **Gráfico** para mostrar un gráfico de barras.
...
4. Agrega una nueva celda de código y ejecuta el código siguiente:
