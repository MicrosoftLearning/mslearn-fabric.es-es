...
3. En el panel **Explorador**, expande **Almacenes de lagos** y, después, expande la lista **Archivos** para tu almacén de lagos y selecciona la carpeta **products** para que aparezca un nuevo panel que muestra el archivo **products.csv** que cargaste anteriormente:
